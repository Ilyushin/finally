...
description: carry out a comprehensive review of the PLAN.md when requested using opencode.
---
...
`opencode run "Please review the file planning/PLAN.md and write your feedback to planning/REVIEW.md"`
